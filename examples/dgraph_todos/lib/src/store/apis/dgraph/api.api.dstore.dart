...
abstract class $Int64FilterCopyWith<O> {
  ...
  O call({int? eq, int? le, int? lt, int? ge, int? gt, Int64Range? between});
}
...
class _$UpdateUserInputCopyWithImpl<O> implements $UpdateUserInputCopyWith<O> {
  ...
  O call(
    ...
    return _then(_value.copyWith(
        filter: filter == dimmutable ? _value.filter : filter as UserFilter,
        set: set == dimmutable ? _value.set : set as UserPatch?,
        remove: remove == dimmutable ? _value.remove : remove as UserPatch?));
  }
}
...
abstract class $AuthorFilterCopyWith<O> {
  ...
  O call(
      {List<String>? id,
      StringTermFilter? name,
      AuthorHasFilter? has,
      List<AuthorFilter?>? and,
      List<AuthorFilter?>? or,
      AuthorFilter? not});
}
...
class _$AuthorFilterCopyWithImpl<O> implements $AuthorFilterCopyWith<O> {
  ...
  O call(
    ...
    return _then(_value.copyWith(
        ...
        name: name == dimmutable ? _value.name : name as StringTermFilter?,
        has: has == dimmutable ? _value.has : has as AuthorHasFilter?,
        and: and == dimmutable ? _value.and : and as List<AuthorFilter?>?,
        or: or == dimmutable ? _value.or : or as List<AuthorFilter?>?,
        not: not == dimmutable ? _value.not : not as AuthorFilter?));
  }
}
...
class _$PostRefCopyWithImpl<O> implements $PostRefCopyWith<O> {
  ...
  O call(
    ...
    return _then(_value.copyWith(
        ...
        author: author == dimmutable ? _value.author : author as AuthorRef?));
  }
}
...
class StringExactFilter {
  ...
  const StringExactFilter(
      {this.eq, this.d$_in, this.le, this.lt, this.ge, this.gt, this.between});
  ...
  @override
  String toString() =>
      "StringExactFilter(eq: ${this.eq}, d$_in: ${this.d$_in}, le: ${this.le}, lt: ${this.lt}, ge: ${this.ge}, gt: ${this.gt}, between: ${this.between})";
}
...
class _$StringExactFilterCopyWithImpl<O>
  ...
  O call(
    ...
    return _then(_value.copyWith(
        ...
        d$_in: d$_in == dimmutable ? _value.d$_in : d$_in as List<String?>?,
...
class _$UserOrderCopyWithImpl<O> implements $UserOrderCopyWith<O> {
  ...
  O call(
    ...
    return _then(_value.copyWith(
        asc: asc == dimmutable ? _value.asc : asc as UserOrderable?,
        desc: desc == dimmutable ? _value.desc : desc as UserOrderable?,
        then: then == dimmutable ? _value.then : then as UserOrder?));
  }
}
...
class _$UpdateAuthorInputCopyWithImpl<O>
  ...
  O call(
      ...
      Object? remove = dimmutable}) {
    return _then(_value.copyWith(
        filter: filter == dimmutable ? _value.filter : filter as AuthorFilter,
        set: set == dimmutable ? _value.set : set as AuthorPatch?,
        remove: remove == dimmutable ? _value.remove : remove as AuthorPatch?));
  }
}
...
abstract class $AddTaskInputCopyWith<O> {
  ...
  O call({String title, bool completed, UserRef user});
}
...
class _$AddTaskInputCopyWithImpl<O> implements $AddTaskInputCopyWith<O> {
  ...
  O call(
    ...
    return _then(_value.copyWith(
        ...
        completed:
            completed == dimmutable ? _value.completed : completed as bool,
        user: user == dimmutable ? _value.user : user as UserRef));
  }
}
...
class _$AddUserInputCopyWithImpl<O> implements $AddUserInputCopyWith<O> {
  ...
  O call(
    ...
    return _then(_value.copyWith(
        ...
        tasks: tasks == dimmutable ? _value.tasks : tasks as List<TaskRef?>?));
  }
}
...
class _$TaskOrderCopyWithImpl<O> implements $TaskOrderCopyWith<O> {
  ...
  O call(
      ...
      Object? then = dimmutable}) {
    return _then(_value.copyWith(
        asc: asc == dimmutable ? _value.asc : asc as TaskOrderable?,
        desc: desc == dimmutable ? _value.desc : desc as TaskOrderable?,
        then: then == dimmutable ? _value.then : then as TaskOrder?));
  }
}
...
class _$UserFilterCopyWithImpl<O> implements $UserFilterCopyWith<O> {
  ...
  O call(
      ...
      Object? not = dimmutable}) {
    return _then(_value.copyWith(
        username: username == dimmutable
            ? _value.username
            : username as StringHashFilter?,
        has: has == dimmutable ? _value.has : has as UserHasFilter?,
        and: and == dimmutable ? _value.and : and as List<UserFilter?>?,
        or: or == dimmutable ? _value.or : or as List<UserFilter?>?,
        not: not == dimmutable ? _value.not : not as UserFilter?));
  }
}
...
abstract class $AuthorPatchCopyWith<O> {
  ...
  O call(
      {String? name, List<PostRef>? posts, List<AuthorRef?>? friends, int? n});
}
...
class _$AuthorPatchCopyWithImpl<O> implements $AuthorPatchCopyWith<O> {
  ...
  O call(
    ...
    return _then(_value.copyWith(
        name: name == dimmutable ? _value.name : name as String?,
        posts: posts == dimmutable ? _value.posts : posts as List<PostRef>?,
        friends: friends == dimmutable
            ? _value.friends
            : friends as List<AuthorRef?>?,
...
class _$PostOrderCopyWithImpl<O> implements $PostOrderCopyWith<O> {
  ...
  O call(
      ...
      Object? then = dimmutable}) {
    return _then(_value.copyWith(
        asc: asc == dimmutable ? _value.asc : asc as PostOrderable?,
        desc: desc == dimmutable ? _value.desc : desc as PostOrderable?,
        then: then == dimmutable ? _value.then : then as PostOrder?));
  }
}
...
class _$UpdatePostInputCopyWithImpl<O> implements $UpdatePostInputCopyWith<O> {
  ...
  O call(
      ...
      Object? remove = dimmutable}) {
    return _then(_value.copyWith(
        filter: filter == dimmutable ? _value.filter : filter as PostFilter,
        set: set == dimmutable ? _value.set : set as PostPatch?,
        remove: remove == dimmutable ? _value.remove : remove as PostPatch?));
  }
}
...
class StringHashFilter {
  ...
  const StringHashFilter({this.eq, this.d$_in});
  ...
  bool operator ==(Object o) {
    if (identical(this, o)) return true;
    return o is StringHashFilter && o.eq == eq && o.d$_in == d$_in;
  }

  @override
  int get hashCode => eq.hashCode ^ d$_in.hashCode;

  @override
  String toString() => "StringHashFilter(eq: ${this.eq}, d$_in: ${this.d$_in})";
}
...
abstract class $StringHashFilterCopyWith<O> {
  ...
  O call({String? eq, List<String?>? d$_in});
}
...
class _$StringHashFilterCopyWithImpl<O>
  ...
  @override
  O call({Object? eq = dimmutable, Object? d$_in = dimmutable}) {
    return _then(_value.copyWith(
        eq: eq == dimmutable ? _value.eq : eq as String?,
        d$_in: d$_in == dimmutable ? _value.d$_in : d$_in as List<String?>?));
  }
...
class _$UpdateTaskInputCopyWithImpl<O> implements $UpdateTaskInputCopyWith<O> {
  ...
  O call(
      ...
      Object? remove = dimmutable}) {
    return _then(_value.copyWith(
        filter: filter == dimmutable ? _value.filter : filter as TaskFilter,
        set: set == dimmutable ? _value.set : set as TaskPatch?,
        remove: remove == dimmutable ? _value.remove : remove as TaskPatch?));
  }
}
...
class _$TaskFilterCopyWithImpl<O> implements $TaskFilterCopyWith<O> {
  ...
  O call(
    ...
    return _then(_value.copyWith(
        ...
        completed:
            completed == dimmutable ? _value.completed : completed as bool?,
        has: has == dimmutable ? _value.has : has as TaskHasFilter?,
        and: and == dimmutable ? _value.and : and as List<TaskFilter?>?,
        or: or == dimmutable ? _value.or : or as List<TaskFilter?>?,
        not: not == dimmutable ? _value.not : not as TaskFilter?));
  }
}
...
class _$AuthorOrderCopyWithImpl<O> implements $AuthorOrderCopyWith<O> {
  ...
  O call(
      ...
      Object? then = dimmutable}) {
    return _then(_value.copyWith(
        asc: asc == dimmutable ? _value.asc : asc as AuthorOrderable?,
        desc: desc == dimmutable ? _value.desc : desc as AuthorOrderable?,
        then: then == dimmutable ? _value.then : then as AuthorOrder?));
  }
}
...
abstract class $PostFilterCopyWith<O> {
  ...
  O call(
      {List<String>? id,
      StringTermFilter? title,
      FloatFilter? score,
      bool? completed,
      DateTimeFilter? datePublished,
      PostHasFilter? has,
      List<PostFilter?>? and,
      List<PostFilter?>? or,
      PostFilter? not});
...
class _$PostFilterCopyWithImpl<O> implements $PostFilterCopyWith<O> {
  ...
  O call(
    ...
    return _then(_value.copyWith(
        id: id == dimmutable ? _value.id : id as List<String>?,
        title: title == dimmutable ? _value.title : title as StringTermFilter?,
        score: score == dimmutable ? _value.score : score as FloatFilter?,
        completed:
            completed == dimmutable ? _value.completed : completed as bool?,
        datePublished: datePublished == dimmutable
            ? _value.datePublished
            : datePublished as DateTimeFilter?,
        has: has == dimmutable ? _value.has : has as PostHasFilter?,
        and: and == dimmutable ? _value.and : and as List<PostFilter?>?,
        or: or == dimmutable ? _value.or : or as List<PostFilter?>?,
        not: not == dimmutable ? _value.not : not as PostFilter?));
  }
}
...
abstract class $TaskRefCopyWith<O> {
  ...
  O call({String? id, String? title, bool? completed, UserRef? user});
}
...
class Task {
  ...
  void user(User user,
      {UserFilter? filter, String? alias, String? directive}) {}
  void d__typename;
}
...
class Author {
  ...
  void postsAggregate(PostAggregateResult postsAggregate,
      {PostFilter? filter, String? alias, String? directive}) {}
  void friendsAggregate(AuthorAggregateResult friendsAggregate,
      {AuthorFilter? filter, String? alias, String? directive}) {}
  void d__typename;
}
...
class Query {
  ...
  void aggregateTask(TaskAggregateResult aggregateTask,
      {TaskFilter? filter, String? alias, String? directive}) {}
  void getUser(User getUser,
      {required String username, String? alias, String? directive}) {}
...
class Mutation {
  ...
  void addPost(AddPostPayload addPost,
      {required List<AddPostInput> input, String? alias, String? directive}) {}
  void updatePost(UpdatePostPayload updatePost,
      {required UpdatePostInput input, String? alias, String? directive}) {}
  void deletePost(DeletePostPayload deletePost,
      {required PostFilter filter, String? alias, String? directive}) {}
  void addAuthor(AddAuthorPayload addAuthor,
      {required List<AddAuthorInput> input,
      String? alias,
      String? directive}) {}
  void updateAuthor(UpdateAuthorPayload updateAuthor,
      {required UpdateAuthorInput input, String? alias, String? directive}) {}
  void deleteAuthor(DeleteAuthorPayload deleteAuthor,
      {required AuthorFilter filter, String? alias, String? directive}) {}
  void addTask(AddTaskPayload addTask,
      {required List<AddTaskInput> input, String? alias, String? directive}) {}
  void updateTask(UpdateTaskPayload updateTask,
      {required UpdateTaskInput input, String? alias, String? directive}) {}
  void deleteTask(DeleteTaskPayload deleteTask,
      {required TaskFilter filter, String? alias, String? directive}) {}
  void addUser(AddUserPayload addUser,
      {required List<AddUserInput> input, String? alias, String? directive}) {}
  void updateUser(UpdateUserPayload updateUser,
      {required UpdateUserInput input, String? alias, String? directive}) {}
  void deleteUser(DeleteUserPayload deleteUser,
      {required UserFilter filter, String? alias, String? directive}) {}
  void d__typename;
}
