...
class SettingsNav extends NestedNavStateI<SettingsNav>
  ...
  @override
  String toString() =>
      "SettingsNav(page: ${this.page}, beforeLeave: ${this.beforeLeave}, meta: ${this.meta}, navOptions: ${this.navOptions}, blockSameUrl: ${this.blockSameUrl}, selectedSetting: ${this.selectedSetting}, listp: ${this.listp})";
}
...
SettingsNav SettingsNav_DS() {
  ...
  state.dontTouchMe.dynamicMeta = {
    '/settings/:id': (Uri uri, Dispatch dispatch) {
      final path = uri.path;
...
abstract class SettingsNavActions {
  static Action<dynamic> details(
    ...
    return Action<dynamic>(
        name: "details",
        silent: silent,
        nav: NavPayload(navOptions: navOptions, rawUrl: '/settings/:id'),
        type: _SettingsNav_FullPath,
