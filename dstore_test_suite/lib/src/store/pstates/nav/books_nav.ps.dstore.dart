...
class BooksNav extends NestedNavStateI<BooksNav>
  ...
  @override
  String toString() =>
      "BooksNav(page: ${this.page}, beforeLeave: ${this.beforeLeave}, meta: ${this.meta}, navOptions: ${this.navOptions}, blockSameUrl: ${this.blockSameUrl}, listP: ${this.listP}, selectedBook: ${this.selectedBook}, author: ${this.author})";
}
...
BooksNav BooksNav_DS() {
  ...
  state.dontTouchMe.dynamicMeta = {
    '/books/:id': (Uri uri, Dispatch dispatch) {
      final path = uri.path;
    ...
    '/books/:id/:name': (Uri uri, Dispatch dispatch) {
      final path = uri.path;
      final parameters = <String>[];
...
abstract class BooksNavActions {
  static Action<dynamic> details(
    ...
    return Action<dynamic>(
        name: "details",
        silent: silent,
        nav: NavPayload(navOptions: navOptions, rawUrl: '/books/:id'),
  ...
  static Action<dynamic> detailsAuthor(
    ...
    return Action<dynamic>(
        name: "detailsAuthor",
        silent: silent,
        nav: NavPayload(navOptions: navOptions, rawUrl: '/books/:id/:name'),
        type: _BooksNav_FullPath,
