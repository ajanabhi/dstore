...
mixin _$WebSocketField<I, R, E> {
  bool get loading;
  R? get data;
  E? get error;
  bool get completed;
  void Function()? get internalUnsubscribe;

  $WebSocketFieldCopyWith<I, R, E, WebSocketField<I, R, E>> get copyWith;
}

class _WebSocketField<I, R, E> implements WebSocketField<I, R, E> {
  @override
  @Default(false)
